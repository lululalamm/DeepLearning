...
def protocol_decoder(protocol):
    ...
    if protocol == "O_to_O":
        ...
        data_name_list_train = ['wild_train']
        data_name_list_test = ['wild_val']
    elif protocol == 'WILD_CELEBA':
        data_name_list_train = ['wild_train','celebA_train']
        data_name_list_test = ['wild_celebA_test']
    elif protocol == 'ALL':
        data_name_list_train = ['wild_train','celebA_train','casia_train']
        data_name_list_test = ['all_test']
    elif protocol == 'W_CA_to_C': # wild , celebA to casia
        data_name_list_train = ['wild_all','celebA_all']
        data_name_list_test = ['casia_all']
    elif protocol == 'W_C_to_CA': # wild, casia to celebA
        data_name_list_train = ['wild_all','casia_all']
        data_name_list_test = ['celebA_all']
    elif protocol == 'CA_C_to_W': # celebA, casia to wild
        data_name_list_train = ['celebA_all','casia_all']
        data_name_list_test = ['wild_all']
