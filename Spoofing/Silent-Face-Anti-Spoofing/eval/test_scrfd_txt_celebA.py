...
def test(args):
    ...
    image_txt,image_base, model_path, device_id = args.image_txt, args.image_base, args.model_path, args.device_id
    model_type ,scale,num_classes = args.model_type, args.scale, args.num_classes
