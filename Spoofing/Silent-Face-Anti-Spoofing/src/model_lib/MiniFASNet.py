...
from torch.nn import Linear, Conv2d, BatchNorm1d, BatchNorm2d, PReLU, ReLU,LeakyReLU, Sigmoid, \
...
class SEModule(Module):
    def __init__(self, channels, reduction):
        ...
        self.bn1 = BatchNorm2d(channels // reduction, eps=1e-4)
        self.relu = LeakyReLU(inplace=True)
        self.fc2 = Conv2d(
            channels // reduction, channels, kernel_size=1, padding=0, bias=False)
        self.bn2 = BatchNorm2d(channels, eps=1e-4)
...
class MiniFASNet(Module):
    def __init__(self, keep, embedding_size, conv6_kernel=(7, 7),
        ...
        self.bn = BatchNorm1d(embedding_size, eps=1e-4)
