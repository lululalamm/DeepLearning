...
class MobileFaceNet(Module):
    def __init__(self, fp16=False, num_features=512,num_classes=4):
        ...
        self.prob = Linear(num_features, num_classes, bias=False) # added
...
def get_mbf(fp16, num_features,num_classes):
    return MobileFaceNet(fp16, num_features,num_classes)