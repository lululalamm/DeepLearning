...
from dataset_agengender_h5 import AgeNGender_Dataset,load_data_hdf5_202_tv,AgeNGender_Dataset_aug
...
def get_args():
    ...
    parser.add_argument("--train_data",type=str,default='',help='training dataset path')
    parser.add_argument("--val_data",type=str,default='',help='training dataset path')
...
def main():
    ...
    backbone = get_cmt_model(pretrained_path = cfg.prepath, num_features=cfg.embedding_size)
    ...
    x_train,y_train = load_data_hdf5_202_tv(train_path)
    x_val, y_val = load_data_hdf5_202_tv(val_path)


    if flagAug:
        print("Augmentation")
        train_set = AgeNGender_Dataset_aug(x_train,y_train,cfg.image_size,'train')
