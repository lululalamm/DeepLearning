...
def main():
    ...
    if "nomargin" in input_data:
        ...
        output_path = "./save_cmt_models/nomargin-{}/{}/".format(cfg.date,input_data.split("/")[-1].split(".")[0])
        final_best_path = "./best_cmt_models/nomargin-{}_{}.pth".format(cfg.date,input_data.split("/")[-1].split(".")[0])
    else:
        makedir("./save_cmt_models/{}/".format(cfg.date))
        output_path = "./save_cmt_models/{}/{}/".format(cfg.date,input_data.split("/")[-1].split(".")[0])
        final_best_path = "./best_cmt_models/{}_{}.pth".format(cfg.date,input_data.split("/")[-1].split(".")[0])
