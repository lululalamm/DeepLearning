...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default="aligned_cropped_face_27716_dlib_{}.txt", help='dataset path.')
    parser.add_argument('--save_base',type=str,default="./checkpoints_new_211123/")
