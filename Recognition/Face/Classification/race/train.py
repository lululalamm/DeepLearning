...
def main():
    ...
    backbone = ArcfaceLinear_mbf(pretrained_path=cfg.prepath, net =cfg.network, num_class=cfg.num_classes, num_features=cfg.num_features,freeze=cfg.freeze,fp16=cfg.fp16)
