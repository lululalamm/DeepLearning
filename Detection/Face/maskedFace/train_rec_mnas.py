...
def get_args():
    ...
    parser.add_argument("--model_name",type=str,default='mnasnet075',help="mnasnet075 / mobilenetv3-small / mobilefacenet")
    ...
    parser.add_argument("--rec_version",type=int,default=1)
    parser.add_argument("--input_size",type=int,default=224)
    parser.add_argument("--load_type",type=int,default=1)
    parser.add_argument("--net_size",type=str,default='075')
...
def init_logging(models_root,args):
    ...
    logging.info("net: {}".format(args.net_size))
...
def train(args):
    ...
    # model load
    model = get_model(args.model_name,num_classes=model_class,load_type=args.load_type,mnas_size=args.net_size)
