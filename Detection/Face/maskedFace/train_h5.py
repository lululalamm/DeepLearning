...
from dataset import MaskDataseth5
...
def get_args():
    ...
    parser.add_argument("--h5_format",type=str,default="FaceMask/facemask_{}.h5")
...
def init_logging(models_root,args):
    ...
    logging.info("train_path: {}".format(args.h5_format.format("train")))
    logging.info("val_path: {}".format(args.h5_format.format("val")))
...
def train(args):
    ...
    # data loader
    train_path = args.h5_format.format("train")
    trainset = MaskDataseth5(train_path)
    val_path = args.h5_format.format("val")
    valset = MaskDataseth5(val_path)
