...
class GDC(Module):
    def __init__(self, embedding_size, input_size=112):
        ...
        self.layers = nn.Sequential(
            LinearBlock(512, 512, groups=512, kernel=(kernel_size, kernel_size), stride=(1, 1), padding=(0, 0)),
            Flatten(),
...
class MobileFaceNet(Module):
    def __init__(self, fp16=False, num_features=512,input_size=112):
        ...
        self.features = GDC(num_features,input_size)
...
class MobileFaceNetCLS(Module):
    def __init__(self,num_classes=2,fp16=False,num_features=512,input_size=112):
        super(MobileFaceNetCLS, self).__init__()
        self.base_net = MobileFaceNet(fp16,num_features,input_size)
...
def get_mbf(num_classes,fp16, num_features,input_size=112):
    return MobileFaceNetCLS(num_classes,fp16, num_features,input_size)